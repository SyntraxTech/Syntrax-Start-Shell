...
namespace SyntraxShell
{
    class Program
    {
        static readonly string SYNTRAX_VERSION = "Syntrax Start Shell";
        static readonly string VERSION = "v7.1 (QopWarren Release)";
        static readonly string PREFIX = "QopWarren (qwe)";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(SYNTRAX_VERSION);
        ...
        static void MainLoop()
        {
            while (true)
            {
                try
                {
                    ...
                    Console.Write("Syntrax>" + Directory.GetCurrentDirectory() + "> ");
                    Console.ResetColor();
            ...
            try
            {
                switch (command)
                {
                    ...
                    case "uptime":
                        ...
                        break;
                    case "exit":
                        Console.WriteLine("Exiting Syntrax shell...");
                        Environment.Exit(0);
                        break;
                    default:
        ...
        static void QweShowHelp()
        {
            ...
            Console.WriteLine(" qwe nyrver        - Show Syntrax version");
        ...
        {
            Console.WriteLine("Syntrax Version = " + SYNTRAX_VERSION);
        ...
        static void QweInfo()
        {
            string[] infos =
            {
                "Hey!, You found the secret message!. Let me tell something about myself then. Im an Dutch dev. Living my life coding Syntrax and going to school. Im Gay, Genderfluid and an secret Femboy. What about you?"
            };
        ...
        {
            Console.WriteLine("Syntrax Has Crashed!");
